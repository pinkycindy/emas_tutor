...
import com.pinkycindy.emas_tutor.coba.MockLocationDetector;
...
public class GPSTracker extends Service implements LocationListener {
    ...
    public Location getLocation() {
        try {
            ...
            Log.d("cretae", "location manager");

//            if(isMockSettingsON(mContext)){
//                try {
//                    Log.d("rmo" ,"Removing Test providers");
//                    Toast.makeText(mContext, "Fake GPS is Active!", Toast.LENGTH_SHORT).show();
//                    locationManager.removeTestProvider(LocationManager.GPS_PROVIDER);
//                } catch (IllegalArgumentException error) {
//                    Log.d("r","Got exception in removing test  provider");
//                }
//            }
//            else{
//                Log.d("false", "false");
